...
void drawNewbox(const int& i0, const int& j0, const int& i1, const int& j1, const float& red, const float& green, const float& blue);
...
public:
	...
	virtual void draw()
	{
		...
		drawNewbox(start_x, start_y, end_x, end_y, 1.0f, 0.0f, 0.0f);
...
void drawNewbox(const int& i0, const int& j0, const int& i1, const int& j1, const float& red, const float& green, const float& blue)
{
	if (xpos > i0+10  && xpos <i1-10  && ypos>j0 + 10 && ypos < j1- 10)
	{
		for (int i = i0 +10; i <= i1 -10; i++)
		{
			const int j = (j0 - j0)*(i - (i0 + 10)) / (i1 - (i0 + 10)) + j0 + 10;
		...
		for (int i = i0 + 10; i <= i1-10; i++)
		{
			const int j = (j1 - j1)*(i - (i0 + 10)) / (i1 - (i0 + 10)) + j1-10;
		...
		{
			const int i = (i0 - i0)*(j - (j0 + 10)) / (j1 - (j0 + 10)) + i0 +10;
		...
		for (int j = j0 + 10; j <= j1 -10; j++)
		{
			const int i = (i1 - i1)*(j - (j0 + 10)) / (j1 - (j0 + 10)) + i1 -10;
...
int main(void)
{
	...
	for (int i = 0; i < 2; i++)
	{
		...
		geo->start_x = 50 + 100 * i*i;
		geo->end_x = 150;
		geo->start_y = 100 + 100 * i* i;
		geo->end_y = 200;
		my_objects[i + 20] = geo;
	...
	for (int i = 2; i < 4; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 50 + 50 * (i*i - 1);
		geo->end_x = 50;
		geo->start_y = 80 + 50 * (i*i - 1);
		geo->end_y = 100;
		my_objects[i + 20] = geo;
	}
	...
	for (int i = 4; i < 6; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 150 * (i - 3)-50;
		geo->end_x = 250;
		geo->start_y = 150 * (i - 3)+50;
		geo->end_y = 350;
		my_objects[i + 20] = geo;
	}
	...
	for (int i = 6; i < 8; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 450 + 400 * (i - 6) / 2 - 50;
		geo->end_x = 250;
		geo->start_y = 450 + 400 * (i - 6) / 2 + 50;
		geo->end_y = 350;
		my_objects[i + 20] = geo;
	}
	...
	for (int i = 8; i < 10; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 150 * (i - 7) - 50;
		geo->end_x = 370;
		geo->start_y = 150 * (i - 7) + 50;
		geo->end_y = 470;
		my_objects[i + 20] = geo;
	}
	...
	for (int i = 10; i < 12; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 450 + 400 * (i - 10) / 2 -50;
		geo->end_x = 370;
		geo->start_y = 450 + 400 * (i - 10) / 2 + 50;
		geo->end_y = 470;
		my_objects[i + 20] = geo;
	}
	...
	for (int i = 12; i < 14; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 150 * (i - 11) - 50;
		geo->end_x = 490;
		geo->start_y = 150 * (i - 11) + 50;
		geo->end_y = 590;
		my_objects[i + 20] = geo;
	}
	...
	for (int i = 14; i < 16; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 450 + 400 * (i - 14) / 2 -50;
		geo->end_x = 490;
		geo->start_y = 450 + 400 * (i - 14) / 2 +50;
		geo->end_y = 590;
		my_objects[i + 20] = geo;
	}
	...
	for (int i = 18; i < 20; i++)
	{
		...
		GeometricObject *geo = new GeometricObject;
		geo->start_x = 450 + 400 * (i - 18) / 2 - 50;
		geo->end_x = 610;
		geo->start_y = 450 + 400 * (i - 18) / 2 + 50;
		geo->end_y = 710;
		my_objects[i + 20] = geo;
	}
